...
export const testCase = async ({
    ...
    await nft.approve(buyer, PaymentProcessorV21.Addresses.Exchange[chainId]);
    ...
    let order = builder.build(orderParameters, PaymentProcessorV21.Order);
    ...
    if (isListing) {
      ...
      order = builder.build(listingParams, PaymentProcessorV21.Order);
...
// describe("PaymentProcessorV2.1 - Indexer Integration Test", () => {
