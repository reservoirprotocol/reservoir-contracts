...
describe("SeaportV16 - SingleToken Erc721", () => {
  ...
  it("Build and fill ERC20 sell order", async () => {
    ...
    // Approve the exchange
    await erc20.connect(buyer).approve(SeaportV16.Addresses.Exchange[chainId], price);
  ...
  it("Build and fill buy order", async () => {
    ...
    // Approve the exchange
    await weth.approve(buyer, SeaportV16.Addresses.Exchange[chainId]);
