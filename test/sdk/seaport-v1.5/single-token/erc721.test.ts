...
import * as SeaportV15 from "@reservoir0x/sdk/src/seaport-v1.4";
...
describe("SeaportV15 - SingleToken Erc721", () => {
  ...
  it("Build and fill ERC20 sell order", async () => {
    ...
    // Approve the exchange
    await erc20.connect(buyer).approve(SeaportV15.Addresses.Exchange[chainId], price);
