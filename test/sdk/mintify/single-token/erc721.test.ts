...
describe("Mintify - SingleToken Erc721", () => {
  ...
  it("Build and fill sell order", async () => {
    ...
    await nft.approve(seller, Mintify.Addresses.Exchange[chainId]);
  ...
  it("Build and fill ERC20 sell order", async () => {
    ...
    // Approve the exchange
    await erc20.connect(buyer).approve(Mintify.Addresses.Exchange[chainId], price);
